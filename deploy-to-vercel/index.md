...
Skill responsável por fazer o deploy de qualquer projeto para a Vercel, priorizando sempre deploys de preview e a configuração a longo prazo através da integração com Git.
...
1. [Uso e Funcionalidades](./uso-e-funcionalidades.md)
2. [Boas Práticas e Integração Git](./boas-praticas.md)
