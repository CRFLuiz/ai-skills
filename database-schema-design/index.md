...
Uma skill estruturada para projetar, refatorar e otimizar esquemas de banco de dados.
...
1. [Coleta de Informações](./coleta-de-informacoes.md)
2. [Definição de Entidades e Atributos](./entidades-e-atributos.md)
3. [Design de Relacionamentos e Normalização](./relacionamentos-e-normalizacao.md)
4. [Estratégia de Indexação](./estrategia-de-indexacao.md)
